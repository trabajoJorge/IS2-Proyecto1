...
public class CreateQuestionGUI extends JFrame {
	...
	private void jbInit(Vector<domain.Event> v) throws Exception {
		...
		jComboBoxEvents.setBounds(new Rectangle(300, 50, 250, 20));
		jLabelListOfEvents.setBounds(new Rectangle(303, 18, 277, 20));
		jLabelQuery.setBounds(new Rectangle(303, 98, 75, 20));
		jTextFieldQuery.setBounds(new Rectangle(300, 130, 250, 20));
		jLabelMinBet.setBounds(new Rectangle(300, 182, 130, 20));
		jTextFieldPrice.setBounds(new Rectangle(420, 182, 130, 20));
		...
		jLabelMsg.setBounds(new Rectangle(274, 228, 288, 32));
